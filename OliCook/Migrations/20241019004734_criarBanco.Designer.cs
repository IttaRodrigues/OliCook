...
namespace OliCook.Migrations
{
    ...
    [Migration("20241019004734_criarBanco")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "ddf093a6-6cb5-4ff7-9a64-83da34aee005",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "02bd3b5a-a0a7-427b-a5c5-c84ba2c94dd5",
                            Email = "admin@olicook.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@OLICOOK.COM",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAIAAYagAAAAEH+EvIKvW3FBmC0VJVzDLOBUAlQ8Ejt2xv6W6s2oaq9+O5kX0o5YtF/wNMjeFYBMMw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "96c3b682-2ede-49f9-a5ef-d86233100559",
            ...
            modelBuilder.Entity("OliCook.Models.Categoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OliCook.Models.Comentario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OliCook.Models.Ingrediente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OliCook.Models.Receita", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OliCook.Models.ReceitaIngrediente", b =>
                {
                    b.Property<int>("ReceitaId")
                        .HasColumnType("int")
                        .HasColumnOrder(1);
            ...
            modelBuilder.Entity("OliCook.Models.Usuario", b =>
                {
                    b.Property<string>("UsuarioId")
                        .HasColumnType("varchar(255)");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataNascimento = new DateTime(1994, 2, 23, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("OliCook.Models.Comentario", b =>
                {
                    b.HasOne("OliCook.Models.Receita", "Receita")
                        .WithMany()
                        .HasForeignKey("ReceitaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OliCook.Models.Usuario", "Usuario")
                        .WithMany()
            ...
            modelBuilder.Entity("OliCook.Models.Receita", b =>
                {
                    b.HasOne("OliCook.Models.Categoria", "Categoria")
                        .WithMany()
            ...
            modelBuilder.Entity("OliCook.Models.ReceitaIngrediente", b =>
                {
                    b.HasOne("OliCook.Models.Ingrediente", "Ingrediente")
                        .WithMany("Receitas")
